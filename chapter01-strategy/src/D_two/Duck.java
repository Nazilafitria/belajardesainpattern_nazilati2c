...
class MallardDuck extends Duck implements Quackable, Flyable {
        ...
        @Override
        void display() {
                System.out.println("Tampilan D_two.MallardDuck");
        }
}
...
class RubberDuck extends Duck implements Quackable {
        ...
        @Override
        void display() {
                System.out.println("Tampilan D_two.RubberDuck");
        }
}
...
class WoodenDuck extends Duck {
        @Override
        void display() {
                System.out.println("Tampilan D_two.WoodenDuck");
        }
}
...
class ToyDuck extends Duck implements Flyable {
        ...
        @Override
        void display() {
                System.out.println("Tampilan D_two.ToyDuck");
        }
}